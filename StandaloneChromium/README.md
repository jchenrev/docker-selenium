...
Selenium Standalone Server with Chromium

## Dockerfile

[`selenium/standalone-chromium` Dockerfile](Dockerfile)

## How to use this image


```
$ docker run -d -p 4444:4444 -v /dev/shm:/dev/shm selenium/standalone-chromium
```
