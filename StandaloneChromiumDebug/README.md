# Selenium Grid Standalone - Chromium Debug
...
[`selenium/standalone-chromium-debug` Dockerfile](Dockerfile)

## How to use this image


```
$ docker run -d -p 4444:4444 -p 5900:5900 -v /dev/shm:/dev/shm selenium/standalone-chromium-debug
```
...
``` dockerfile
FROM selenium/node-chromium-debug-debug:3.141.59-20210422
